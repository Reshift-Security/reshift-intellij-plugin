...
import com.reshiftsecurity.plugins.intellij.gui.preferences.LegacyAbstractSettingsConverter;
		...
		if ("project".equalsIgnoreCase(root.getName())) {
			for (final Element component : root.getChildren()) {
				if ("component".equalsIgnoreCase(component.getName())) {
					if ("ReshiftSecurity-Intellij".equalsIgnoreCase(component.getAttributeValue("name"))) {
						return component;
					}
				}
			}

...
/**
 * Legacy. Do not use this anymore. This will be converted by {@link LegacyProjectSettingsConverter}.
 */
public class PersistencePreferencesBean {
	...
	/**
	 * URL's, use {@link FindBugsCustomPluginUtil#getAsFile(String)} etc.
	 */
